 ...
 *  the standalone "send a test WhatsApp" control (not tied to a specific
 *  duty). Kept as the original SUNDAY_ADVANCE/FRIDAY_REMINDER identifiers
 *  (not shortened to SUNDAY/FRIDAY) so duplicate-protection matching still
